...
/**
    ...
    * 
    *  Modifications:
    *    - added better error reporting to include file name and line number
    * 
    ********************
*/
...
class XMLParser 
{
    ...
    */
    ...
    {
        trigger_error('XML Parsing Error at ('.$this->filename.') line:'.$line.' col:'.$col.'. Error '.$code.': '.xml_error_string($code));
    }
