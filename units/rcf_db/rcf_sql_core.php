<?php
	...
	*  Name..: RCF Database Engine
	*  Desc..: Abstraction library for simplified database usage
	*/
	...
	*/
	...
	define('RCF_DB_VERSION','0.5');
	define('OBJECT','OBJECT',true);
	define('ARRAY_A','ARRAY_A',true);
	define('ARRAY_N','ARRAY_N',true);
	define('RCF_CORE_ERROR','RCF DB Engine can not be used by itself (it is designed for use by database specific modules).');
	...
	*/
	...
	class rcfDBcore
	{
		...
		*/
		...
		/**********************************************************************
		*  Connect to DB - overridden by specific DB class
		*/
		...
		/**********************************************************************
		*  Select DB - overridden by specific DB class
		*/
		...
		/**********************************************************************
		*  Basic Query	- overridden by specific DB class
		*/
		...
		/**********************************************************************
		*  Format a string correctly for safe insert - overridden by specific
		*  DB class
		*/
		...
		*/
		...
		/**********************************************************************
		*  Print SQL/DB error - overridden by specific DB class
		*/
		...
		*/
		...
		function vardump($mixed='')
		{
			...
			{
				echo "<font color=800080><b>rcfDB</b> (v".rcfDB_VERSION.") <b>Variable Dump..</b></font>\n\n";
			}
		...
		*/
		...
		function debug()
		{
			...
			// Only show rcfDB credits once..
			if ( ! $this->debug_called )
			{
				echo "<font color=800080 face=arial size=2><b>rcfDB</b> (v".rcfDB_VERSION.") <b>Debug..</b></font><p>\n";
			}
