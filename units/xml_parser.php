...
class XMLParser
{
    ...
    */
	...
	/**
	 * Original file XML was derived from, used only for debugging
	 *
	 * @var string
	 */
    private $filename;
     ...
     * @return XMLParser
     */
    function __construct($xml = '', $filename = '', $cleanTagNames = false)
    {
        //Load XML document
        $this->xml = $xml;
    ...
    {
        trigger_error('XML Parsing Error at ('.$this->filename.') line:'.$line.', char:'.$col.'. Error '.$code.': '.xml_error_string($code));
    }
