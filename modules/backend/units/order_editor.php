...
final class OrderEditor {
	...
	private function __construct($parent, $manager_class) {
		$this->parent = $parent;
		$this->manager = $manager_class::get_instance();
	}
	...
	public function tag_List($tag_params, $children) {
		...
		$items = $this->manager->get_items($feilds, array(), $this->order_field, true);
