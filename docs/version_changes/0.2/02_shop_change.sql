...
ALTER TABLE `shop_buyers` ADD COLUMN `phone` varchar(200) DEFAULT '' AFTER `email`;
...
ALTER TABLE `shop_delivery_address` ADD COLUMN `email` varchar(127) DEFAULT '' AFTER `street2`;
