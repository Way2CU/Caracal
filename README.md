...
3. Framework tags
	...
	11. [Privacy conditional template parsing - `cms:privacy`](docs/tags/privacy.markdown)
	12. [Multiple choice conditional parsing - `cms:choice`](docs/tags/choice.markdown)
	13. [Parse child nodes only on desktop version - `cms:desktop`](docs/tags/desktop.markdown)
	14. [Parse child nodes only on mobile version - `cms:mobile`](docs/tags/mobile.markdown)
	15. [Parse child nodes for logged in users - `cms:user`](docs/tags/user.markdown)
	16. [Parse child nodes for guests only - `cms:guest`](docs/tags/guest.markdown)
	17. [Include variable or parameter value - `cms:var`](docs/tags/var.markdown)
	18. [Include script in head tag - `cms:script`](docs/tags/script.markdown)
